...
public abstract class MainItem extends ParentItem {
...
//        });
    ...
    public void loadImage(TubelessMainViewHolder holder, ParentItem timelineItem) {
...
//    public abstract void fill(Context mContext,
