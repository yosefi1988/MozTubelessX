...
/**
 * Created by s.yousefi on 04/07/2018.
 */

public class PersianCalendar1 implements Serializable {
    ...
    public static String getPersianDateTime(Date d) {
        GregorianCalendar gc = new GregorianCalendar();
        gc.setTime(d);
        int year = gc.get(Calendar.YEAR);
    ...
    public static Calendar getGregorianCalendar(PersianCalendar1 jalali){
     ...
     * Constructor
     * */
    public PersianCalendar1(Calendar gregorian) {
     ...
     * */
    public PersianCalendar1(String jalaliString){
    ...
    public PersianCalendar1(PersianCalendar1 jalali){
        setPersainCalendarWithJalali(jalali.getYear(), jalali.getMonth(), jalali.getDay(),
                jalali.getHour(), jalali.getMinute(), jalali.getSecond());
    }

    public PersianCalendar1(int jalaliyear, int jalalimonth, int jalaliday){
        setPersainCalendarWithJalali(jalaliyear, jalalimonth, jalaliday);
    }

    public PersianCalendar1(int jalaliyear, int jalalimonth, int jalaliday, int jalalihour,
    ...
    public boolean isEqual(PersianCalendar1 jalali){
    ...
    public int compareTo(PersianCalendar1 jalali){
