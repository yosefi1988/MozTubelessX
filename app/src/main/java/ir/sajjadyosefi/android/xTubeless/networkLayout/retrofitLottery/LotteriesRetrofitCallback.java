...
public class LotteriesRetrofitCallback<Object> implements Callback<java.lang.Object> {
    ...
    public LotteriesRetrofitCallback(Context context, View rootView, boolean showResult, View buttonSubmit, Callback<java.lang.Object> callback) {
...
//                responseX2.setTubelessException(serverstatus);
                sException.handleServerMessage(mContext, responseX2);
            }
