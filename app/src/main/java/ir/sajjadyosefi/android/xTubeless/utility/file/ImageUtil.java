...
public class ImageUtil {
    ...
    public void downloadImageAndPreview(Context mContext , ir.sajjadyosefi.android.xTubeless.classes.model.file.File file, ImageView imageView) {
        //download image
    ...
    private void loadImageWithRetrofit(Context context, ir.sajjadyosefi.android.xTubeless.classes.model.file.File file, ImageView imageView) {
